...
// Input
// The first line contains a single integer t (1≤t≤100)  — the number of test cases. The only line of each test case contains two integers a and b (0≤a,b<10)  — the number of '1's and the number of '2's in the array.

...
void solve()
{
    ...
    //Check non-edges for 0s
    for (int i = 1; i < r - 1; i++)
    {
        for (int j = 1; j < r - 1; j++)
        {
            //Inside matrix positions should be 0
            if (s[i * r + j] != '0')
            {
                cout << "No" << endl;
                return;

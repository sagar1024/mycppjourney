...
// What is the maximum number of operations you can perform? Recall that gcd(x,y) means the greatest common divisor of integers x and y.

// Input
// Each test consists of multiple test cases. The first line contains a single integer t (1≤t≤500) — the number of test cases. The description of the test cases follows. The only line of each test case contains two integers l and r (1≤l≤r≤1000) — the range of integers in the initial set.

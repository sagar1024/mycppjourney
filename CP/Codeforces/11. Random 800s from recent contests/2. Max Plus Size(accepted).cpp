...
void solve()
{
    ...
    //The maxx should be in odd index(atleast one)
    bool oddMax = false;
    for(int i=0; i<n; i++)
    {
        if(a[i]==maxx && (i+1)%2!=0)
    ...
    else
    {
        ...
        {
            cout << maxx + ceil((float)n/2) - 1 << endl;
        }
    }

...
// Input
// The first line contains one integer t (1≤t≤1000) — the number of test cases. Each test case consists of two lines: the first line contains one integer n (2≤n≤40) — the number of points in the set;the second line contains n integers x1,x2,…,xn (1≤x1<x2<⋯<xn≤100) — the points from the set.
